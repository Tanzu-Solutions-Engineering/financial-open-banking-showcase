...
#helm chart pull registry.tanzu.vmware.com/tanzu-sql-postgres/postgres-operator-chart:v1.2.0
#helm chart export registry.tanzu.vmware.com/tanzu-sql-postgres/postgres-operator-chart:v1.2.0  --destination=/tmp/
