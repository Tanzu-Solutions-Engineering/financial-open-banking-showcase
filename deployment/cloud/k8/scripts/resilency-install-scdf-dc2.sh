...
kubectl apply -f deployment/cloud/k8/data-services/rabbitmq/secret/shovel/dc1-to-dc2-accounts-scdf.yml

kubectl describe shovel dc1-dc2-account-dataflow-shovel
