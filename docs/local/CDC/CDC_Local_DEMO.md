...
start server --name=server   --locators=127.0.0.1[10334] --bind-address=127.0.0.1 --hostname-for-clients=127.0.0.1


run --file=/Users/Projects/VMware/Tanzu/Use-Cases/Vertical-Industries/VMware-Financial/dev/financial-open-banking-showcase/deployment/gemfire/gfsh_setup.txt
```

ATM CDC App

```shell
java -jar /Users/Projects/VMware/Tanzu/SCDF/dev/scdf-extensions/applications/jdbc-cdc-rabbitmq-source/target/jdbc-cdc-rabbitmq-source-0.0.2-SNAPSHOT.jar --spring.profiles.active=local-bank-atm --cdc.source.jdbc.sqlSelectWithFrom="select atm_id,update_ts, json_build_object('atm_id',atm_id,'update_ts',update_ts,'id', atm_id, 'bank_id', bank_id,'name',atm_name,'address',json_build_object('line_1',address_line_1,'line_2',address_line_2,'line_3',address_line_3,'city',address_city,'county',address_county,'state',address_state,'postcode',address_postcode,'country_code',address_country_code),'meta',json_build_object('license',json_build_object('id',meta_license_id,'name',meta_license_name)), 'monday',json_build_object('opening_time',monday_opening_time,'closing_time',monday_closing_time),'tuesday',json_build_object('opening_time',tuesday_opening_time,'closing_time',tuesday_closing_time),'wednesday',json_build_object('opening_time',wednesday_opening_time,'closing_time',wednesday_closing_time),'thursday',json_build_object('opening_time',thursday_opening_time,'closing_time',thursday_closing_time),'friday',json_build_object('opening_time',friday_opening_time,'closing_time',friday_closing_time),'saturday',json_build_object('opening_time',saturday_opening_time,'closing_time',saturday_closing_time),'sunday',json_build_object('opening_time',sunday_opening_time,'closing_time',sunday_closing_time),'is_accessible',is_accessible,'located_at',located_at,'more_info',more_info,'has_deposit_capability',has_deposit_capability) as json FROM bank_atms" --cdc.source.jdbc.jsonColumnNamePosition=3

```
```shell
java -jar applications/atm-geode-sink/target/atm-geode-sink-0.0.2-SNAPSHOT.jar
```
