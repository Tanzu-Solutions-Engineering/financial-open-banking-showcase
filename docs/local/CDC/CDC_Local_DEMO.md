...
```shell
java -jar /Users/Projects/VMware/Tanzu/SCDF/dev/scdf-extensions/applications/jdbc-cdc-rabbitmq-source/target/jdbc-cdc-rabbitmq-source-0.0.2-SNAPSHOT.jar --spring.profiles.active=local-bank-atm --cdc.source.jdbc.sqlSelectWithFrom="select atm_id,update_ts, json_build_object('atm_id',atm_id,'update_ts',update_ts,'id', atm_id, 'bank_id', bank_id,'name',atm_name, 'monday',json_build_object('opening_time',monday_opening_time,'closing_time',monday_closing_time),'tuesday',json_build_object('opening_time',tuesday_opening_time,'closing_time',tuesday_closing_time)) as json FROM bank_atms" --cdc.source.jdbc.jsonColumnNamePosition=3
