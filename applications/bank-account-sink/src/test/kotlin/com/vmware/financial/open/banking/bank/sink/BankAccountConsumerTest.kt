...
/**
 * BankConsumerTest test for AccountConsumer
 */
internal class BankAccountConsumerTest {

    @Test
    fun accept() {
        var atmService : AccountService = mock<AccountService>()
        var subject  = BankAccountConsumer(atmService)
        val bankAccount = JavaBeanGeneratorCreator.of(BankAccount::class.java).create()
        subject.accept(bankAccount)
        verify(atmService).createAccount(any<BankAccount>())
    }
    ...
    internal fun parsing() {
        ...
        var atm = JavaBeanGeneratorCreator.of(BankAccount::class.java).create()
    ...
    internal fun parsingJackson() {
        ...
        var atmObject = JavaBeanGeneratorCreator.of(BankAccount::class.java).create()
